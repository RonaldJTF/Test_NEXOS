...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator, PopoverModule, ButtonModule],
                ...
                <div class="layout-topbar-menu-content items-center">
                    <ng-container *ngIf="users?.length; else noUsers">
                        <div class="flex justify-center">
                            <p-button type="button" [label]="selectedUser ? selectedUser.name : 'Select User'" (onClick)="toggle($event)" styleClass="min-w-60" />
                            <p-popover #op>
